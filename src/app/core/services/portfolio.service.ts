...
export class PortfolioService {
  ...
  private getMockHeroData(): HeroData {
    return {
      ...
      description:
        'Especializado en desarrollo web moderno con Angular, React, Laravel y diseño centrado en el usuario. Desde Lima, Perú, ofrezco soluciones tecnológicas innovadoras.',
  ...
  private getMockAboutData(): AboutData {
    return {
      ...
      story:
        'Con más de 9 años de experiencia, he trabajado con startups y empresas establecidas creando soluciones web innovadoras. Mi enfoque combina técnicas de desarrollo avanzadas con principios de diseño UX/UI para crear experiencias digitales excepcionales.',
      skills: {
        frontend: [
          'Angular',
          'React',
      ...
      timeline: [
        {
          ...
          description:
            'Liderando equipos de desarrollo en proyectos de gran escala utilizando Angular y Laravel.',
        ...
        },
        {
          ...
          description:
            'Desarrollo de aplicaciones web responsivas y optimización de performance.',
    ...
    return {
      ...
      services: [
        ...
        },
        {
          ...
          title: 'UI/UX Design',
          description:
            'Diseños atractivos y funcionales centrados en el usuario',
          features: [
            'Wireframes',
            'Prototipos',
            'Design System',
        ...
        },
        {
          ...
          description:
            'Diseños creativos para fortalecer la identidad visual de tu marca',
          features: [
            'Logotipos',
            'Branding',
        ...
        },
        {
          ...
          description:
            'Asistencia técnica remota para instalación y configuración de software',
          features: [
            'Soporte Remoto',
            'Configuración',
            'Capacitación',
        ...
        },
        {
          ...
          description:
            'Consultoría especializada en herramientas de IA para pequeñas y medianas empresas',
          features: [
    ...
    return {
      ...
      featured: [
        {
          ...
          category: 'Full Stack',
          description:
            'Plataforma completa de comercio electrónico con panel administrativo',
          image:
      ...
      projects: [
        ...
        },
        {
          ...
          category: 'UI/UX',
          description:
            'Sitio web informativo corporativo con diseño profesional',
          image:
        ...
        },
        {
          ...
          category: 'Full Stack',
          description:
            'Plataforma de blog con sistema de gestión de contenidos',
          image:
        ...
        },
        {
          ...
          category: 'Frontend',
          description:
            'Plataforma de cursos online con sistema de gestión de aprendizaje',
          image:
    ...
    return {
      ...
      testimonials: [
        ...
        },
        {
          ...
          avatar:
            'https://images.unsplash.com/photo-1494790108755-2616b612b586?w=200&h=200&fit=crop&crop=face',
          rating: 5,
          project: 'App Móvil',
          date: '2024-01-20',
          clientImage:
  ...
  private getMockBlogData(): BlogData {
    return {
      ...
      featured: {
        ...
        excerpt:
          'Descubre las técnicas más avanzadas para optimizar tu aplicación Angular con las últimas características del framework.',
      ...
      posts: [
        {
          ...
          excerpt:
            'Guía paso a paso para mejorar el SEO y performance de tu aplicación Angular con Server-Side Rendering.',
